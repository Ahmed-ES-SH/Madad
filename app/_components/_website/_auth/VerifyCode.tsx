            ...
            >
              ...
              >
                {loading ? (
                  ...
                  <p> {verifyCode.verifyEmailTitle}</p>
                )}
              </motion.button>
            </form>
          </div>
      ...
      {sureMessage && (
        ...
        >
          <div className="lg:w-1/2 w-[80%] bg-white flex flex-col gap-4 items-center py-6 px-2 rounded-md">
            ...
            <p className="text-icon-color">{verifyCode.deactivationWarning}</p>
